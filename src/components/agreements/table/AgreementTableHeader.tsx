  ...
  return (
    <TableHeader className="bg-gradient-to-r from-gray-50 to-gray-100">
      <TableRow className="hover:bg-gray-50/50 transition-colors">
        <TableHead className="w-[150px] py-3 font-semibold">
        ...
        <TableHead className="w-[120px] py-3 font-semibold">
          <div className="flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors group cursor-pointer">
        ...
        <TableHead className="w-[200px] py-3 font-semibold">
          <div className="flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors group cursor-pointer">
        ...
        <TableHead className="text-right w-[150px] py-3 font-semibold">
