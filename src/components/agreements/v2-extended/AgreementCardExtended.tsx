...
import { getStatusConfig, getPaymentConfig, calculatePaymentProgress } from "../v2/utils";
...
interface AgreementCardExtendedProps {
  agreement: Agreement;
...
export const AgreementCardExtended = ({
  agreement,
  onViewDetails,
  onDelete,
  onSelect,
  isSelected = false
}: AgreementCardExtendedProps) => {
