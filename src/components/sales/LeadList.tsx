                      ...
                      >
                        ...
                        <div className="flex gap-2 flex-wrap">
                          <Button
                            variant="secondary"
                            size="sm"
                            onClick={() => handleStatusChange(lead.id, "document_collection")}
                            disabled={lead.status === "document_collection"}
                          >
                            Request Documents
                          </Button>
                          <Button
                            variant="secondary"
                            size="sm"
                            onClick={() => handleStatusChange(lead.id, "vehicle_selection")}
                            disabled={lead.status === "vehicle_selection"}
                          >
                            Select Vehicle
                          </Button>
                          <Button
