...
export const AgreementCreate = lazy(() => import("@/pages/AgreementCreate"));
export const AgreementPayments = lazy(() => import("@/pages/AgreementPayments"));
export const AgreementDetails = lazy(() => import("@/pages/AgreementDetails"));
...
export const PortalTest = lazy(() => import("@/pages/PortalTest"));
